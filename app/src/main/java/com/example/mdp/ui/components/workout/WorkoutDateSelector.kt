...
@Composable
fun WorkoutDateSelector(navController: NavController) {
    ...
    Box(
        ...
        Row(
            ...
            IconButton(onClick = {
                ...
                navController.navigate(NavRoutes.RouteToWorkout.route) {
                    popUpTo(NavRoutes.RouteToWorkout.route) { inclusive = false }
                }
            }) {
                Icon(
